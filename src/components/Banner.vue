<template>
  <div v-if="!isHidden"
    ...
    <div class="absolute left-[max(-7rem,calc(50%-52rem))] top-1/2 -z-10 -translate-y-1/2 transform-gpu blur-2xl"
      aria-hidden="true">
      <div class="aspect-[577/310] w-[36.0625rem] bg-gradient-to-r from-[#ff80b5] to-[#9089fc] opacity-30" style="
          clip-path: polygon(
            74.8% 41.9%,
            97.2% 73.2%,
            100% 34.9%,
    ...
    <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
      <p class="text-sm leading-6 text-gray-900">
        ...
        </svg>Join us from Dec 27 – 29 to see what’s coming next.
      </p>
      <a href="/register"
    ...
    <div class="flex flex-1 justify-end">
      <button v-on:click="isHidden = true" type="button" class="-m-3 p-3 focus-visible:outline-offset-[-4px]">
...
export default {
  ...
  mounted() {
    ...
    this.isHidden = authStore.userIsAuth
  }
}
</script>