    ...
    <div>
      ...
      <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
          <h1 class="text-4xl font-bold tracking-tight text-gray-900">Sales</h1>
        ...
        <section aria-labelledby="products-heading" class="pb-24 pt-6">
          ...
          <Paginiation :page="page" :totalDocs="totalDocs" :totalPage="totalPage"></Paginiation>
        </section>
      </main>
    </div>
  </div>
...
import Paginiation from "../components/Paginiation.vue";
export default {
  components: {
    ProductList,
    Paginiation
  ...
  mounted() {
    ...
    axios.get(API_URL + "?page=1&size=12").then(response => {
